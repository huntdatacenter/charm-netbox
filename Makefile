...
# Charm variables
CHARM_NAME := netbox
CHARM_STORE_URL := cs:~huntdatacenter/netbox
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-netbox/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-netbox/issues
